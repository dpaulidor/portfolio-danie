  ...
  return (
    <section className="about-container">
      ...
      <div className="about-text">
        ...
        <p>
          Je m’appelle <strong>Danika Paulidor</strong>, étudiante en <strong>sciences informatiques</strong> à l’Université Espoir de Calvary Chapel.
          Passionnée par le développement, j’aime résoudre des problèmes et créer des projets utiles.
        </p>

        <p>
          Mon objectif : devenir <strong>développeuse fullstack</strong> et mettre mes compétences au service de projets sociaux et technologiques, notamment en Haïti.
        </p>

        {/* CV Buttons */}
        <div className="cv-buttons">
          <a href="/cv_danie.pdf" download className="btn btn-download">📥 Télécharger le CV</a>
          <a href="/cv_danie.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-view">👁️ Lire en ligne</a>
        </div>
      </div>
    </section>
  );
